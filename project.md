...
Even if the response of the authorities were similar in these countries, with the suspension of non essential activities, interdiction of meetings etc… , these measures have probably been applied in a more or less strict way. Moreover, the response of the population is non uniform across the different countries, leading to very different evolutions of mobilities.
